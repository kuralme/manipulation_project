...
class ObjectDetection(Node):
    def __init__(self) -> None:
        ...
        self.pc_sub = self.create_subscription(PointCloud2, '/camera/depth/color/points', self.callback, 10)
    ...
    def callback(self, msg: PointCloud2) -> None:
        try:
            ...
            filtered_cloud_plane = self.filter_cloud(cloud, max_x_dist=0.8, min_height=-0.06, max_height=-0.02)
            # Filtered cloud for object detection
            filtered_cloud_objects = self.filter_cloud(cloud, max_x_dist=0.6, min_height=-0.018, max_height=0.1)
